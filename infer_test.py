...
def visualize_ply(ply_path):
    ...
    ptCloud = o3d.io.read_point_cloud(ply_path)
...
# # clip_fields demo query
# query = "Warm up my lunch"
query = "Open the trash can"
...
valid_points = get_and_show_valid_points(coordinates) # show heatmap
...
# visualize_ply("./visualized_pointcloud/model_nyu_kitchen_open the trash can_thres.ply")